...
export const CHAT_AGENT_ADDRESS =
  process.env.NEXT_PUBLIC_CHAT_AGENT_ADDRESS || ''
export const CHAT_AGENT_INBOX_ID =
  process.env.NEXT_PUBLIC_CHAT_AGENT_INBOX_ID || ''
export const CHAT_AGENT_ENV = (process.env.NEXT_PUBLIC_CHAT_AGENT_ENV ||
  'local') as ClientOptions['env']
